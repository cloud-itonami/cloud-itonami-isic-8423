# Operator Quickstart — Public Order and Safety Administrative Operations

Shortest path from clone to a verified local dry-run for **ISIC 8423** (`cloud-itonami-isic-8423`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-8423.git
cd cloud-itonami-isic-8423
```
...
- Blueprint governor key: `public-safety-governor`
- Likely source path: `safety.governor.cljc`
